...
def make_parser():
    ...
    parser.add_argument(
        "--path",
        default="../../data/Swiss_vs_Slovakia-panoramic_video.mp4",
        help="path to images or video",
    )
    parser.add_argument(
        "--output_db",
        default="../../data/soccer_analitics.db",
        help="path to bd",
    )
    parser.add_argument(
        "--path_to_field",
        default="../../data/soccer_field.png",
        help="path to soccer field image",
    )
    parser.add_argument(
        "--h_matrix_path",
        default="../../data/h_matrix_path.npy",
        help="path to soccer field image",
    )
    parser.add_argument(
        "--path_to_det",
        default="../../models/yolov8m_all_data.pt",
        help="path to detector model",
    )
    parser.add_argument(
        "--ball_det",
        default="../../models/ball_SN5+52games.pt",
        help="path to detector model",
    )
    parser.add_argument(
        "--path_to_reid",
        default="../../models/osnet_ain_x1_0_triplet_custom.pt",
